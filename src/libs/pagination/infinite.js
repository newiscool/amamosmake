...
$(document).ready(function(){
    ...
    if(infinite.attr('data-infinite') != 'false') {
        ...
        if(paginates.length) {
            ...
            let loadmore    = $(`<button class="carregar_mais" type="button">`).text(textButton);
            ...
            if(buttonNext.length) {
                ...
                loadmore.click(function(){
                    ...
                    if(src.length) {
                        ...
                        loadmore
                            .addClass('carregar_mais--loading')
                            .attr('disabled', true)
                        ...
                        $.get(src)
                            .then((data) => {
                                ...
                                loadmore
                                    .removeClass('carregar_mais--loading')
                                    .attr('disabled', false)
                                    .text(textButton);
